...
public class ZetaReport {
	...
	public void createReport(HashMap<String,String> String ) throws Exception {
		...
		bufferedWriter.write("<!DOCTYPE html>\r\n" + "<html>\r\n" + "<head></head>\r\n" + "<body>\r\n" + "\r\n"
				...
				+ "    <th>Status</th>\r\n" + "  </tr>");
		for (int currentRow = 1; currentRow <= String.size(); currentRow++) {
			
			if (!"Pass".equalsIgnoreCase(String.get("Pass"))) {
		...
		bufferedWriter.write("<script type=\"text/javascript\" X-Content-Security-Policy: sandbox; default-src 'none'; img-src 'self'; style-src 'self'; src=\"https://www.gstatic.com/charts/loader.js\"></script>\r\n"
